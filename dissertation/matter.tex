...
\documentclass[11pt,a4paper,openright,twoside,onecolumn,final]{memoir}
...
\include{chapters/principles-of-rfid}
\include{chapters/epcglobal}
\include{chapters/smart-shelves}
\include{chapters/requirements-options}
\include{chapters/system-architecture-dev}
\include{chapters/test-evaluation}
...
% Load errata
\includepdf[pages=-,pagecommand={},width=\paperwidth]{chapters/errata.pdf}

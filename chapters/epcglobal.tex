...
\begin{listing}
    \inputminted[linenos]{xml}{./code/sota/LRSpec.xml}
...
\begin{listing}
    \inputminted[linenos]{xml}{./code/sota/ECSpec.xml}
...
\begin{listing}
    \inputminted[linenos]{xml}{./code/sota/EC_REPORT_deletions.xml}

...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.9\textwidth]{./figs/02-state-of-the-art/architecture-framework-activities.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.4\textwidth]{./figs/02-state-of-the-art/llrp-interaction}
    \caption{\ac{llrp} in the \emph{EPCglobal} Architecture~\cite{Llrp1standard20101013Pdf}} 

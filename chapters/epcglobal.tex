...
Reader only allows one \ac{llrp} connection at any time. The end-to-end \ac{tcp} connection between reader and client stays open till the client closes it or connection drops.

\subsection{Specification}

The primary function of the \ac{llrp} interface is to allow a client to to finely tune the \ac{gen2} Tag Air Standard parameters and commanding the reader to inventory tags and otherwise access tags for read, write, lock, and kill.

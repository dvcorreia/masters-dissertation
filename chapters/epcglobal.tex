...
Stock levels could be precisely controlled and shared with trading partners through the up and downstream, which in turn reduces inventory costs and optimizes intra-company operations~\cite{lorenzDiscoveryServicesEPC2011, simchi-leviCadeiasSuprimentosProjeto2003}.
...
The \emph{End Users} parties in a supply chain that exchange physical objects that are identified with \acp{epc}.

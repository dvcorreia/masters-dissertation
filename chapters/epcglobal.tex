...
The \ac{gtin} is used by companies to identify trade items. 
...
A \ac{gtin} is composed of a \emph{Company Prefix}, a \emph{Item Reference} and a check digit:

\paragraph{Company Prefix} is a unique identifier licensed by GS1. Nowadays, the registration of Company Prefix is essential procedure for companies whistling   of \acp{gtin} 

It identifies not only the company 
...
~\cite{GS1GTINExecutive, GS1GTINManagement}



\subsubsection{RFID/Barcode Interoperability}

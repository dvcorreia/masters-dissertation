...
The \emph{EPCGlobal Architecture Framework} can become very extensive, separated in multiple documents and show inconsistencies between documents, making the introduction to the framework fairly hard.
Throughout this section I will introduce the baseline implementation of the \emph{EPCGlobal Framework}, introducing each intervening member and their role within the architecture framework. This should provide a foundation to contextualize the next sections where they will be thoroughly explained.

The \emph{Architecture Framework} provides detailed specifications for three technologies developed by the EPCGlobal team: the \acf{epc}, components of the EPCGlobal Network™

The simplest implementation of the \emph{EPCGlobal Architecture Framework} can be structured like shown in figura~\ref{fig:archstructure}.

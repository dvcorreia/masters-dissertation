...
The \ac{uhf} \ac{rfid} design solution, chosen for the smart shelve, consists of a single compact antenna and reader attached to the bottom shelf, radiating upwards.

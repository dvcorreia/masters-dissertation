...
The implementation of the smart shelve had to be simple and cost constrained. Due to time constrains, the development of custom hardware had to be avoid in favor of the \emph{EPCGlobal Architecture Framework} implementation.

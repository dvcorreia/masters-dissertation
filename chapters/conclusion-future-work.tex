...
The advance of cloud computing, \ac{iot} and \emph{Industry 4.0} encouraged the supply chain and logistics industries to digitize their operations and further optimise their resources. 
...
It followed by discussing and presenting multiple hardware architectural designs, \ac{rnd} resources required to implement those and evaluating each development option in regard to costs and time.
...
The \ac{rfid} hardware solution was tested for performance, evaluating tag optimal orientation, performing an \ac{rf} survey in different zones of the shelf and a stress of testing poor \ac{rf} condition zones. The shelf showed limited effect on \ac{rf} communications thus not confirming the initial assessment of problems it could present.

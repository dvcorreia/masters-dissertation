...
\Title{\selectlanguage{portuguese}Arquitectura EPCGlobal: Implementação para Gestão de Inventório}
...
\Title{\selectlanguage{english}EPCGlobal Architecture: Implementation for Retail Inventory Management}

...
\Title{\selectlanguage{portuguese}Arquitectura EPCGlobal: Implementação de Estante Inteligente para Gestão de Inventário}
...
\Abstract{Palavras Chave}{RFID, UHF, estante, inteligente, EPCGlobal, EPC.}
...
\Abstract{Keywords}{RFID, UHF, smart, shelf, EPCGlobal, EPC.}
